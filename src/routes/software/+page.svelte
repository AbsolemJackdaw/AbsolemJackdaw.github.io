...
<div class="flex flex-col items-center mt-5 text-4xl font-bold m-48">
    ...
    <div class="bg-black w-[40rem] m-3 p-1 rounded-2xl hover:scale-110 justify-items-center">
        ...
        <a href="https://github.com/AbsolemJackdaw/PaintingPackMaker/releases" target="_blank" class="decoration-0">
            <div class="container flex flex-row">
                <img src="/github_dark.png" alt=""
                     class="w-[10rem] rounded-tl-2xl rounded-2xl"/>
                <p class="w-fit flex pt-2 pb-1 text-slate-100 font-bold [font-size:1rem] [line-height:1.25rem] [font-family:monospace] ">
